...
annotations.df <- read.csv("/home/sidneyz/sjogren_results/own_data/seurat_v1.4b/recluster_analyses/gc_recluster_donorsep.csv")
...
tonsil <- readRDS("/home/sidneyz/sjogren_data/tonsil/20220215_tonsil_atlas_cite_seurat_obj.rds")
...
#From raw matrices
germinal_3a.cite <- read_table(gzfile("/home/sidneyz/sjogren_data/germinal_center_data_withcite/GSM4560816_GC3a_Ab_counts.txt.gz"))
germinal_3b.cite <- read_table(gzfile("/home/sidneyz/sjogren_data/germinal_center_data_withcite/GSM4560817_GC3b_Ab_counts.txt.gz"))
germinal_3a.gex <- read_table(gzfile("/home/sidneyz/sjogren_data/germinal_center_data_withcite/GSM4560814_GC3a_umi.txt.gz"))
germinal_3b.gex <- read_table(gzfile("/home/sidneyz/sjogren_data/germinal_center_data_withcite/GSM4560815_GC3b_umi.txt.gz"))
...
saveRDS(germinal_3a, "/home/sidneyz/sjogren_data/germinal_center_data_withcite/germinal_3a.RDS")
saveRDS(germinal_3b, "/home/sidneyz/sjogren_data/germinal_center_data_withcite/germinal_3b.RDS")
```


```{r Create seurat objects from germinal centre datasets}
#Read in data from processed matrices (code chunk above)
germinal_3a <- readRDS("/home/sidneyz/sjogren_data/germinal_center_data_withcite/germinal_3a.RDS")
germinal_3b <- readRDS("/home/sidneyz/sjogren_data/germinal_center_data_withcite/germinal_3b.RDS")
...
write.csv(markers, "/home/sidneyz/sjogren_results/tonsil/tonsilintegration_fullobject_RNA_markers.csv")
write.csv(fullpanel_markers, "/home/sidneyz/sjogren_results/tonsil/tonsilintegration_fullobject_CITE_markers_fullpanel.csv")

markers <- read.csv("/home/sidneyz/sjogren_results/tonsil/tonsilintegration_fullobject_RNA_markers.csv")
fullpanel_markers <- read.csv("/home/sidneyz/sjogren_results/tonsil/tonsilintegration_fullobject_CITE_markers_fullpanel.csv")
```
...
#Save object
saveRDS(combined, "/home/sidneyz/sjogren_results/tonsil/combined.RDS")
```
...
write.csv(combined_markers, "/home/sidneyz/sjogren_results/tonsil/tonsilintegration_subset_v1.4b_RNA_markers.csv")
write.csv(combined_markers.cite, "/home/sidneyz/sjogren_results/tonsil/tonsilintegration_subset_v1.4b_CITE_markers.csv")
```

```{r Read in results}
#Read in the marker genes if found earlier:
combined_markers <- read.csv("/home/sidneyz/sjogren_results/tonsil/tonsilintegration_subset_v1.4b_RNA_markers.csv")
combined_markers.cite <- read.csv("/home/sidneyz/sjogren_results/tonsil/tonsilintegration_subset_v1.4b_CITE_markers.csv")
...
umap_annotation
saveRDS(umap_annotation, "/home/sidneyz/figures/UMAP_tonsil_annotated.RDS")
```
...
saveRDS(plot_gc, "/home/sidneyz/sjogren_results/figures/gc_mapping_tonsil.RDS")
```
