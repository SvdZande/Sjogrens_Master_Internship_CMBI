...
gc_meta <- read.csv("/home/sidneyz/sjogren_results/own_data/combined/gc_recluster_donorsep.csv")
...
png(file="/home/sidneyz/sjogren_results/own_data/combined/cellchat_interaction_heatmap.png", width=1920, height=1100)
...
```{r Save results}
#Save results
saveRDS(cellchat, "/home/sidneyz/sjogren_results/own_data/combined/cellchat.RDS")
