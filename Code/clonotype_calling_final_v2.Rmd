...
*author note: should you ever run into the 'cannot establish connection' error when trying to save or open a file, paste that line into the terminal and run it from there. It probably cannot find the directory you are looking for.*
...
write.csv(contig, "/home/sidneyz/sjogren_results/own_data/clonotyping/clonotypes_ownscript_mathijs_threshold2_0405.csv")
...
write.csv(contig, "/home/sidneyz/sjogren_results/own_data/clonotyping/clonotypes_ownscript_mathijs_threshold3_0405.csv")
...
write.csv(contig, "/home/sidneyz/sjogren_results/own_data/clonotyping/clonotypes_ownscript_mathijs_threshold4_0405.csv")
...
write.csv(contig_0507, "/home/sidneyz/sjogren_results/own_data/clonotyping/clonotypes_B005B007_mathijs_threshold2_0405.csv")
...
write.csv(contig_0507, "/home/sidneyz/sjogren_results/own_data/clonotyping/clonotypes_B005B007_mathijs_threshold3_0405.csv")

contig_0507 <- contig

#Threshold 4
contig_0507 <- clonotype(contig_0507, threshold = 4, levenshtein = F)
write.csv(contig_0507, "/home/sidneyz/sjogren_results/own_data/clonotyping/clonotypes_B005B007_mathijs_threshold4_0405.csv")
...
contig_full_02 <- read.csv("/home/sidneyz/sjogren_results/own_data/clonotyping/clonotypes_ownscript_mathijs_threshold2_0405.csv")
contig_full_03 <- read.csv("/home/sidneyz/sjogren_results/own_data/clonotyping/clonotypes_ownscript_mathijs_threshold3_0405.csv")
contig_full_04 <- read.csv("/home/sidneyz/sjogren_results/own_data/clonotyping/clonotypes_ownscript_mathijs_threshold4_0405.csv")

contig_b0057_02 <-  read.csv("/home/sidneyz/sjogren_results/own_data/clonotyping/clonotypes_B005B007_mathijs_threshold2_0405.csv")
contig_b0057_03 <-  read.csv("/home/sidneyz/sjogren_results/own_data/clonotyping/clonotypes_B005B007_mathijs_threshold3_0405.csv")
contig_b0057_04 <-  read.csv("/home/sidneyz/sjogren_results/own_data/clonotyping/clonotypes_B005B007_mathijs_threshold4_0405.csv")
...
ggplot(clonotype_numbers, aes(x = threshold, y = clonotype_number, fill = factor(threshold))) + geom_col(position = "dodge") +
...
#D00*
contig_full <- read.csv("/home/sidneyz/sjogren_results/own_data/clonotyping/clonotypes_ownscript_mathijs_threshold2_0405.csv")
contig_full$clonotype_new <- as.character(contig_full$clonotype_new)
contig_full$X <- NULL

#B00*
contig_0507 <- read.csv("/home/sidneyz/sjogren_results/own_data/clonotyping/clonotypes_B005B007_mathijs_threshold2_0405.csv")
...
write.csv(contig_full, "/home/sidneyz/sjogren_results/own_data/clonotyping/clonotypes_ownscript_mathijs_threshold2_0405_annotated.csv")
write.csv(contig_0507, "/home/sidneyz/sjogren_results/own_data/clonotyping/clonotypes_B005B007_mathijs_threshold2_0405_annotated.csv")

contig_full <- read.csv("/home/sidneyz/sjogren_results/own_data/clonotyping/clonotypes_ownscript_mathijs_threshold2_0405_annotated.csv")
contig_0507 <- read.csv("/home/sidneyz/sjogren_results/own_data/clonotyping/clonotypes_B005B007_mathijs_threshold2_0405_annotated.csv")
```
...
write.csv(contig_all, "/home/sidneyz/sjogren_results/own_data/clonotyping/alldonors_mathijs_threshold2_0405_annotated.csv")
```
...
write.csv(contig_seurat, "/home/sidneyz/sjogren_results/own_data/clonotyping/alldonors_mathijs_threshold2_0405_annotated_seuratmeta.csv")
```
...
write.csv(contig_full_03, "sjogren_results/own_data/clonotyping/clonotypes_ownscript_mathijs_threshold3_0405_annotated.csv")
write.csv(contig_full_04, "sjogren_results/own_data/clonotyping/clonotypes_ownscript_mathijs_threshold4_0405_annotated.csv")

write.csv(contig_b0057_03, "sjogren_results/own_data/clonotyping/clonotypes_B005B007_mathijs_threshold3_0405_annotated.csv")
write.csv(contig_b0057_04, "sjogren_results/own_data/clonotyping/clonotypes_B005B007_mathijs_threshold4_0405_annotated.csv")


contig_full_02 <- read.csv("sjogren_results/own_data/clonotyping/clonotypes_ownscript_mathijs_threshold2_0405_annotated.csv")
contig_full_03 <- read.csv("sjogren_results/own_data/clonotyping/clonotypes_ownscript_mathijs_threshold3_0405_annotated.csv")
contig_full_04 <- read.csv("sjogren_results/own_data/clonotyping/clonotypes_ownscript_mathijs_threshold4_0405_annotated.csv")

contig_b0057_02 <- read.csv("sjogren_results/own_data/clonotyping/clonotypes_B005B007_mathijs_threshold2_0405_annotated.csv")
contig_b0057_03 <- read.csv("sjogren_results/own_data/clonotyping/clonotypes_B005B007_mathijs_threshold3_0405_annotated.csv")
contig_b0057_04 <- read.csv("sjogren_results/own_data/clonotyping/clonotypes_B005B007_mathijs_threshold4_0405_annotated.csv")
...
```{r Examine overlap manually}
#Examine the overlap manually due to gene notations differing between D002 and B007
overlap <- intersect(D002_LN_contigs$cdr3_nt, B007_contigs$cdr3_nt)

D002_overlap <- D002_LN_contigs[D002_LN_contigs$cdr3_nt %in% overlap,]
B007_overlap <- B007_contigs[B007_contigs$cdr3_nt %in% overlap,]
D002_overlap <- D002_overlap[D002_overlap$chain == "IGH",]

B007_overlap <- B007_overlap[B007_overlap$chain == "IGH",]
