...
#save the output
saveRDS(threshold_list, "/home/sidneyz/sjogren_results/own_data/immcantation_files/immcantation_thresholds_withB00.rds")

threshold_list <- readRDS("/home/sidneyz/sjogren_results/own_data/immcantation_files/immcantation_thresholds_withB00.rds")
...
saveRDS(results_list, "/home/sidneyz/sjogren_results/own_data/immcantation_files/immcantation_clonotyping_withB00.rds")
results_list <- readRDS("/home/sidneyz/sjogren_results/own_data/cimmcantation_files/immcantation_clonotyping_withB00.rds")
```
...
#Save the result
saveRDS(baseline_list, "/home/sidneyz/sjogren_results/own_data/immcantation_files/baseline_withB00.rds")
saveRDS(data_h_list, "/home/sidneyz/sjogren_results/own_data/immcantation_files/data_h_withB00.rds")
saveRDS(collapse_list, "/home/sidneyz/sjogren_results/own_data/immcantation_files/collapseclones_withB00.rds")

```

```{r Load in results}
#If you already have the results generated in the chunk above, you can load them here:
data_h_list <- readRDS("/home/sidneyz/sjogren_results/own_data/immcantation_files/data_h_withB00.rds")
baseline_list <- readRDS("/home/sidneyz/sjogren_results/own_data/immcantation_files/baseline_withB00.rds")
collapse_list <- readRDS("/home/sidneyz/sjogren_results/own_data/immcantation_files/collapseclones_withB00.rds")
```
...
png(file="/home/sidneyz/sjogren_results/figures/figure_5.png", width=1000, height = 1600)
patch5 + plot_annotation(tag_levels = "A") & 
  theme(plot.tag = element_text(size = 22, face = "bold"))
dev.off()

#Make the supplemental figure that demonstrates the isotypes
png(file="/home/sidneyz/sjogren_results/figures/supplemental_figure_isotypes.png", width=800, height = 600)
isotype_plot
dev.off()
